...
if not _RELEASE:
    _component_func = components.declare_component(
        # We give the component a simple, descriptive name ("tiny_streamlit_webrtc"
...
def tiny_streamlit_webrtc(name, key=None):
    """Create a new instance of "tiny_streamlit_webrtc".
...
# app: `$ streamlit run tiny_streamlit_webrtc/__init__.py`
if not _RELEASE:
